...
namespace ArgusLabs.DF.Core.Communications
{
    ...
    public class ClaimHomePlanetReceipt
    {
        [SerializeField] private ClaimHomePlanetReply result;
        ...
        public PlanetReceipt Planet => result.ClaimedPlanet;
        public PlayerComponent Player => result.CreatedPlayer;
    }
}