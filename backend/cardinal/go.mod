module github.com/argus-labs/darkfrontier-backend/cardinal

go 1.21.0

toolchain go1.21.2

// TODO: required to fix weird version issues with Cosmos SDK
replace (
	cosmossdk.io/x/evidence => github.com/rollkit/cosmos-sdk/x/evidence v0.0.0-20230714164100-d5353aba3338
	github.com/argus-labs/darkfrontier-backend/circuit => ../circuit
	github.com/cometbft/cometbft => github.com/rollkit/cometbft v0.0.0-20230614163111-d6a8d2c98cc0
	github.com/consensys/gnark-crypto => github.com/consensys/gnark-crypto v0.9.2
...
require (
	...
	github.com/argus-labs/darkfrontier-backend/circuit v0.0.0-00010101000000-000000000000
...
require (
	...
	pkg.world.dev/world-engine/assert v1.0.1-0.20231127015827-7181fc4e75ba // indirect
